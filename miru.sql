...
-- Dump completed on 2022-07-22 14:23:07
...
CREATE TABLE `favorite` (
  ...
  `pictureOrder` int DEFAULT NULL,
  PRIMARY KEY (`id`,`pictureIdx`),
  KEY `pictureIdx` (`pictureIdx`),
  CONSTRAINT `favorite_ibfk_1` FOREIGN KEY (`id`) REFERENCES `user` (`id`) ON DELETE CASCADE,
  CONSTRAINT `favorite_ibfk_2` FOREIGN KEY (`pictureIdx`) REFERENCES `picture` (`pictureIdx`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
